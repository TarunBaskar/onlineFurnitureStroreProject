      ...
      return (  
          <header>
             ...
             <div className='header2'>
              <h1 id='header2_h1'>Welcome to Indian Furniture</h1>
              <p id='header2_p'> We offer ready-to-order furnitures plus many option for customer</p>
             </div>
             {/* <h1 style={{padding:'100px'}}>Home page</h1> */}
             <div className='image-slider' style={{paddingTop:'50px',paddingLeft:'250px',backgroundColor:'white'}}>
             < SimpleImageSlider />
             </div><br/>
             <div className='row'>
      ...
      <section className='allProducts'>
        ...
        <div className='allproduct_list'>
            <div className='allp' >
              ...
              <Link to='bed'><img src={bedhome} width='300px'style={{borderRadius:'70px'}}/></Link>
              <Rating rating={4.3}/>
                  <h3>Conshohocken Upholstered Bed</h3>
                  <h4><span>&#8377;</span>70,000</h4>
            </div>
            <div className='allp' >
            <Link to='dinning_set'><img src={dinninghome} width='300px' style={{borderRadius:'70px'}}/></Link>
            <Rating rating={4.9}/>
            <h3>Modern Simple Rectangular White Horse Belly Dining Table Sets</h3>
                  <h4><span>&#8377;</span>15,50,000</h4>
            </div>
            <div className='allp'>
            <Link to='sofa'><img src={sofahome} width='300px' style={{borderRadius:'70px'}}/></Link>
            <Rating rating={4.6}/>
            <h3>Garzon 69.68" Faux Leather Square Arm Sofa</h3>
                  <h4><span>&#8377;</span>90,000</h4>
            </div>
            <div className='allp' >
            <Link to='dressing_table'><img src={dressinghome} width='300px' style={{borderRadius:'70px'}}/></Link>
            <Rating rating={5}/>
