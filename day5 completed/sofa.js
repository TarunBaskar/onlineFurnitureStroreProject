...
const Sofa = () => {
  ...
  return (
    ...
    <div className='sofa_productList'>
      ...
      <p style={{textAlign:'center',fontFamily:'font-serif italic'}}>"Unwind in opulence on a sofa that embraces you with plush sophistication, where every moment becomes a lavish retreat."</p>
      <br></br><div className="product-list">
